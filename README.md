...
首版有意保持克制：角色会呼吸、观察、回正、轻微点头和重心变化，视线先于头部，身体与发饰延迟跟随；嘴部始终不动，没有闭眼素材时也不会强行压扁眼睛。目标是“看起来在合理地动”，而不是凭空补画角色或追求动作数量。
...
格式字段和兼容约定见 [项目格式](docs/PROJECT_FORMAT.md)，包边界与运行链见 [架构说明](docs/ARCHITECTURE.md)。
