...
param(
  ...
  [ValidateSet("inspect", "create", "verify", "describe", "migrate", "render", "psd", "agent", "author", "actions", "calibrate", "compare", "history", "restore", "evidence", "enhance", "record", "play", "edit", "runtime", "cubism", "extensions")]
  [string]$Command,
