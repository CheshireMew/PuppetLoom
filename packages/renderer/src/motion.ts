...
export class CalmMotionController {
  ...
  sample(timeSeconds: number, options: MotionSampleOptions = {}): MotionState {
    ...
    return this.modelPhysics.sample({
      ...
      blinkLeft: controlled("blinkLeft", this.project.runtime.features.blink ? blinkValue(timeSeconds, this.project.runtime.seed) : 0),
      blinkRight: controlled("blinkRight", this.project.runtime.features.blink ? blinkValue(timeSeconds, this.project.runtime.seed) : 0),
      browLeft: controlled("browLeft", 0),
      browRight: controlled("browRight", 0),
      smile: controlled("smile", 0),
      cheekPuff: controlled("cheekPuff", 0),
      ...
      mouthA: controlled("mouthA", 0),
      mouthI: controlled("mouthI", 0),
      mouthU: controlled("mouthU", 0),
      mouthE: controlled("mouthE", 0),
      mouthO: controlled("mouthO", 0),
      armLeft: controlled("armLeft", 0),
      armRight: controlled("armRight", 0),
      handLeftX: controlled("handLeftX", 0),
      handLeftY: controlled("handLeftY", 0),
      handRightX: controlled("handRightX", 0),
      handRightY: controlled("handRightY", 0),
      handLeftOpen: controlled("handLeftOpen", 0),
      handRightOpen: controlled("handRightOpen", 0),
